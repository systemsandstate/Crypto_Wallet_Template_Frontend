...
const ReportOutline: React.FC<{ color: string; size: number }> = ({ color, size }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
        <Path
            d="M5 6.5h14a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-11a1 1 0 0 1 1-1Zm1 2.75h12V8.5H6v.75Zm6 2.5a2.75 2.75 0 1 1 0 5.5 2.75 2.75 0 0 1 0-5.5Zm0 1.5a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5Z"
            fill={color}
        />
        <Path d="M7.5 6.5 7.5 4.75h2V6.5M14.5 6.5V4.75h2V6.5" fill={color} />
    </Svg>
);

const ReportSvg: React.FC<Props> = ({
    color = "#4C4C60",
    size = MENU_ICON_SIZE,
    variant = "filled",
}) => {
    if (variant === "outline") {
        return <ReportOutline color={color} size={size} />;
    }
